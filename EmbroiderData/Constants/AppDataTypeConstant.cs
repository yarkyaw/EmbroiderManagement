...
// Type: EmbroideryData.Constants.AppDataTypeConstant
...
{
  public static class AppDataTypeConstant
  {
    public static string DecimalDataType = "decimal(18,2)";
    public static string DateDataType = "Date";
  }
}
