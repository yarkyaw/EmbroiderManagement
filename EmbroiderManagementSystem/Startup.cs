using AutoMapper;
using EmbroiderManagementSystem.Authorization;
using EmbroiderManagementSystem.Helpers;
using EmbroiderOrderyService;
...
using System.Net;
using AppPermissions = EmbroideryData.Constants.ApplicationPermissions;
...
namespace EmbroiderManagement
{
    ...
    public class Startup
    {
        ...
        {
            services.AddDbContext<EmbroideryContext>(options =>
                options.UseSqlServer(Configuration["ConnectionStrings:DefaultConnection"], b => b.MigrationsAssembly("EmbroiderManagementSystem"))
                );
            ...
            services.AddSingleton<IAuthorizationHandler, AssignRolesAuthorizationHandler>();
            services.AddTransient<IDatabaseInitializer, DatabaseInitializer>();
            services.AddScoped<IEmbroiderService, EmbroiderService>();
            services.AddScoped<IProductService, ProductService>();
            services.AddScoped<IEmbroiderOrderService, EmbroiderOrderService>();
            services.AddScoped<IEmbroiderInvoiceService, EmbroiderInvoiceService>();
            services.AddScoped<IEmbroiderServiceItemHistoryService, EmbroiderServiceItemHistoryService>();
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.DocumentTitle = "Swagger UI - sample";
            ...
            app.UseSpa(spa =>
            {
                ...
                if (env.IsDevelopment())
                {
                    ...
                    spa.Options.StartupTimeout = TimeSpan.FromSeconds(700); // Increase the timeout if angular app is taking longer to startup
