...
// Type: EmbroiderManagementSystem.Authorization.UserAccountAuthorizationRequirement
...
namespace EmbroiderManagementSystem.Authorization
{
  ...
  {
    public UserAccountAuthorizationRequirement(string operationName) => this.OperationName = operationName;
